variable "region" {
  ...
  type = string
  default = "eu-west-2" # Change it to your preferred region
}
...
variable "ami_id" {
  ...
  type        = string
  default     = "ami-0e56583ebfdfc098f" // Replace with your  MI ID for your region
}
...
variable "key_name" {
  ...
  type        = string
  default     = "LondonKP" # give your region keypair 
}
